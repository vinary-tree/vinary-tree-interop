...
| Canonical facade source | [`vinary-tree-interop/bindings/python`](../../../vinary-tree-interop/bindings/python) |
...
Use `with` for `resource` and `resource handle`. Finalizers are leak containment, not a deterministic resource policy.
