...
export function assertLatticeProvider(provider) {
...
export function assertSemiringProvider(provider) {
...
export function normalizeLatticeProviderOptions(options) {
  const domainId = normalizeProviderOptions(options, "lattice");
  return Object.freeze({ domainId });
}

export function normalizeSemiringProviderOptions(options) {
